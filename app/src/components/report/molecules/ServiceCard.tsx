...
export default function ServiceCard(props: PropsType) {
  ...
  return (
    <BaseStyle>
      ...
      <RatingStyle>
        {isGood ? (
          <IconGoodActive onClick={clickGood} style={iconStyle} />
        ) : (
          <IconGoodInactive onClick={clickGood} style={iconStyle} />
        )}

        {isBad ? (
          <IconBadActive onClick={clickBad} style={iconStyle} />
        ) : (
          <IconBadInactive onClick={clickBad} style={iconStyle} />
        )}
      </RatingStyle>
    </BaseStyle>
  );
